...
Proprietary. Commercial use requires a license from H33.ai, Inc. Source is available for research, audit, and reference-implementation purposes. See [LICENSE](./LICENSE) for details.

Patent pending — H33 substrate Claims 124-125.

For commercial licensing: billing@h33.ai
